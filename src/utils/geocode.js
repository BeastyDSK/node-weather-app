...
const GeoCode = {
    ...
    withcoords(latitude, longitude, callback) {
        const GeocodeURL = `https://api.mapbox.com/geocoding/v5/mapbox.places/${encodeURIComponent(longitude)},${encodeURIComponent(
            latitude
        )}.json?limit=1&access_token=pk.eyJ1Ijoia3Jpc2huYWRzayIsImEiOiJja2EzaGltbzkwNm40M2tvNDlueGo4NW9wIn0.YLvgwSX4baon3DSK5RTFhg`;
